...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-frontend/flexsearch.min.js');loadScript('/study-frontend/en.search-data.min.bf826f667cf13b6261ca1097ccb76c6996e9d74e03519651644fb9a4f13a4164.js',function(){input.required=false;search();});}
