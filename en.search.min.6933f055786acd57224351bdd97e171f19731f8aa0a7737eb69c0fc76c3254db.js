...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/frontend/flexsearch.min.js');loadScript('/frontend/en.search-data.min.0a60491df1d7d88c37b790f4f1ccae099f51f04cf8ed7b1a9e122d080be0a49f.js',function(){input.required=false;search();});}
