...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.171bfedf656f78f7726cb11449d1be6c301a460df2efaa3eb2fd776824f69c86.js',function(){input.required=false;search();});}
